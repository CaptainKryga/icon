...
SRC_PRINTF =	analise.c\
				...
				print_string.c
SRC =			main.c\
                bmp_reader/array_file_type.c\
                players.c\
                help.c\
                bmp_reader/bmp_info.c\
                bmp_reader/get_blocks.c\
                bmp_reader/glob_texture_funks.c\
                bmp_reader/rle_file_type.c\
                bmp_reader/texture_add_funks.c
INCLUDE = 		-Ilibftprintf\
			   	-Ilibftprintf/libft
HEAD =			head.h\
                bmp_reader/my_doom.h
